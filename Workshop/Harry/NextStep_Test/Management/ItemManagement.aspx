        ...
        <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand" DataKeyNames="ItemId" DataSourceID="ItemSource" InsertItemPosition="LastItem" OnItemDeleted="ListView1_ItemDeleted" OnItemDeleting="ListView1_ItemDeleting">
            ...
            <EditItemTemplate>
                <fieldset>
                    ...
                    <asp:TextBox ID="ItemNameTextBox" runat="server" Text='<%# Bind("ItemName") %>' ValidateRequestMode="Inherit" />
                    ...
                    <asp:TextBox ID="DescriptionTextBox" runat="server" Text='<%# Bind("Description") %>' TextMode="MultiLine" ValidateRequestMode="Disabled" />
                    <br />
