<%@ Page Language="C#" AutoEventWireup="true" CodeFile="formViewEdit.aspx.cs" Inherits="formViewEdit" %>
...
<body>
    ...
    <div>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="CustomerID" DataSourceID="sdsCustomers">
            <EditItemTemplate>
                CustomerID:
                <asp:Label ID="CustomerIDLabel1" runat="server" Text='<%# Eval("CustomerID") %>' />
                <br />
                <asp:Label ID="Label1" runat="server" AssociatedControlID="CompanyNameTextBox" Text="Company Name:"></asp:Label>
                &nbsp;<asp:TextBox ID="CompanyNameTextBox" runat="server" Text='<%# Bind("CompanyName") %>' />
                <br />
                <asp:Label ID="Label2" runat="server" AssociatedControlID="ContactNameTextBox" Text="Contact Name:"></asp:Label>
