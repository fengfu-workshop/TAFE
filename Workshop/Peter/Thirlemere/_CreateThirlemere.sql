...
IF EXISTS (SELECT * FROM MASTER..sysdatabases
					WHERE name = N'Thirlemere_Fengfu_Chen_Fengfu_Chen')
...
CREATE TABLE Thirlemere_Fengfu_Chen.dbo.horse (
	...
	CONSTRAINT sire_fk FOREIGN KEY (sire) REFERENCES horse,
	CONSTRAINT dam_fk FOREIGN KEY (dam) REFERENCES horse
)
GO

CREATE TABLE Thirlemere_Fengfu_Chen.dbo.show (
...
CREATE TABLE Thirlemere_Fengfu_Chen.dbo.judge (
...
CREATE TABLE Thirlemere_Fengfu_Chen.dbo.event (
	event_id	nchar(4) NOT NULL,
	show_id		nchar(2),
	event_name	nvarchar(15),
	judge_id	nchar(2),
	CONSTRAINT event_pk PRIMARY KEY(event_id),
	CONSTRAINT show_id_fk FOREIGN KEY (show_id) REFERENCES show,
	CONSTRAINT judge_id_fk FOREIGN KEY (judge_id) REFERENCES judge
)
GO

CREATE TABLE Thirlemere_Fengfu_Chen.dbo.entry (
	event_id	nchar(4) NOT NULL,
	horse_id	nchar(3) NOT NULL,
	place		tinyint,
	CONSTRAINT entry_pk PRIMARY KEY(event_id, horse_id),
	CONSTRAINT horse_id_fk FOREIGN KEY (horse_id) REFERENCES horse,
	CONSTRAINT event_id_fk FOREIGN KEY (event_id) REFERENCES event
)
GO

CREATE TABLE Thirlemere_Fengfu_Chen.dbo.prize (
	event_code	nchar(4) NOT NULL,
	place		tinyint NOT NULL,
	prizemoney	money,
	CONSTRAINT prize_pk PRIMARY KEY(event_code, place),
	CONSTRAINT event_code_fk FOREIGN KEY (event_code) REFERENCES event
)
GO
