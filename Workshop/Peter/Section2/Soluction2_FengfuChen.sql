...
BEGIN
    ...
    -- Insert statements for procedure here
		-- List the event_id and event_name for each event, together with the name of the judge who is judging it. (hint - join the event and judge tables)
...
BEGIN
    ...
    -- Insert statements for procedure here
		-- LList the name of each horse who has been awarded a first place. Do not display the name of a horse more than once.
