...
CREATE TABLE RobsRentals_Fengfu_Chen.dbo.customer(
	cust_num	NCHAR(4),
	title			NVARCHAR(4),
...
CREATE TABLE RobsRentals_Fengfu_Chen.dbo.model(
...
CREATE TABLE RobsRentals_Fengfu_Chen.dbo.appliance(
	stock_num    NCHAR(4), 
...
CREATE TABLE RobsRentals_Fengfu_Chen.dbo.hire(
	stock_num   NCHAR(4),
	date_hired  DATETIME,
	cust_num		NCHAR(4),
	paid_till   DATETIME,
